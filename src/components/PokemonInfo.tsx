...
const PockemonInfo : React.FC<Props> = ({id,name,types,color})=>{
  ...
  return(
    <Base color={mapColorToHex(color?.name)}>
      ...
      <ThumbnailImageWrapper>
        <ThumbnailImage src={`https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/dream-world/${id}.svg`}/>
      </ThumbnailImageWrapper>
    </Base>
  )
}
